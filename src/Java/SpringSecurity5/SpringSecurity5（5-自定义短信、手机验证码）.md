---
title: SpringSecurity5（5-自定义短信、手机验证码）
tag:
  - SpringSecurity
category: Java
date: 2025-02-08 22:38:34
description: 本文介绍如何在 Spring Security 中自定义验证码和短信验证码校验，包括生成验证码、存储与校验逻辑、过滤器配置及适配认证流程，确保用户安全登录，同时提升灵活性与可扩展性。适用于登录安全加固及自定义认证需求。
---
...
![](SpringSecurity5（5-自定义短信、手机验证码）/1.png)
...
![](SpringSecurity5（5-自定义短信、手机验证码）/2.png)
