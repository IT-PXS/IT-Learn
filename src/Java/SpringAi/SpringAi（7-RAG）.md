---
title: SpringAi（7-RAG）
tag: 
    - SpringAi
    - Ai
category: Java
description: Spring AI 的 RAG 框架将检索增强生成流程模板化。它通过集成向量搜索，自动从外部知识库中检索相关文档片段，并将其作为上下文注入提示词，引导大模型生成更精准、可靠的回答，有效缓解“幻觉”问题。
date: 2025-12-07 22:38:34
---
